...
var fakeReferrer = "http://logotv.com?env=" + casper.environment.mtv.slice(7);
...
casper.waitForSelector("a#logo", function() {
    this.echo('Navigated to ' + this.getCurrentUrl(), "COMMENT");
});
