...
casper.reporting.params = {params:["c1","c7","c14","c28","ch","v49"],c28:"interviews page"};

casper.test.comment('Testing reporting on Lady Gaga interviews page');
...
casper.thenOpen(url_prefix + 'artists/lady-gaga/video-interviews/', function() {});
