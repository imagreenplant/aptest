...
casper.test.comment('Testing reporting on Lady Gaga similar artist page');
...
casper.thenOpen(url_prefix + 'artists/lady-gaga/related-artists/?filter=similar', function() {
