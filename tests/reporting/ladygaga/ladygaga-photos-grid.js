...
casper.reporting.params = {params:["c1","c7","c14","c28","ch","v49"],c28:"photos page"}

casper.test.comment('Testing reporting on Lady Gaga photos grid page');
...
casper.thenOpen(url_prefix + 'artists/lady-gaga/photos/', function() {});
