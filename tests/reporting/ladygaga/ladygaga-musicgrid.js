...
casper.reporting.params = {params:["c1","c7","c14","c28","ch","v49"],c28:"music page"};

casper.test.comment('Testing reporting on Lady Gaga music grid page');
...
casper.thenOpen(url_prefix + 'artists/lady-gaga/music/', function() {});
