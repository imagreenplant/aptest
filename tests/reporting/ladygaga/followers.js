...
casper.test.comment('Testing reporting on Lady Gaga following artists page');
...
casper.thenOpen(url_prefix + 'artists/lady-gaga/related-artists/?filter=followers', function() {
