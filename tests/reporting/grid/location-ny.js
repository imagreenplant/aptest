...
casper.reporting.params = {params:["c28","ch","v49"],c28:"location page"};

casper.test.comment('Testing reporting on location page');
...
casper.thenOpen(url_prefix + 'artists/location/New+York+City%2C+NY/#from-lady-gaga', function() {
