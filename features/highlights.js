...
casper.then(function() {
	...
	this.test.assertEquals(this.fetchText('td.copy-container div.copy').replace(/(^\s+|\s+$)/g,' '), " CMT Listen Up: JB and the Moonshine Band: Whether they're singing of passionate love or passionate partying, this group brings the vigor to their spirited set. Watch as this Texas group performs \"The Only Drug,\" \"Perfect Girl\" and more during their live performance. Read More ", "should find text");
